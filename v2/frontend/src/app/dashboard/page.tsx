...
export default function DashboardPage() {
  ...
  // Signed out, or nothing parsed yet: the home page explains the app, so send
  // people there rather than showing an empty dashboard.
  if (!session?.signed_in || (!stats?.receipt_count && !run)) {
    return (
      <>
        <PageHeader title={t("dashboard.title")} description={t("dashboard.descriptionIdle")} />
        <Panel>
          <Empty title={t("dashboard.connectTitle")}>
